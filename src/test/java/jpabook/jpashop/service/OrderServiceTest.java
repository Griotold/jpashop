...
public class OrderServiceTest {
    ...
    public void 상품주문()throws Exception {
        ...
        assertEquals("상품 주문시 주문 상태는 ", OrderStatus.ORDER, getOrder.getStatus());
    ...
    public void 주문취소()throws Exception {
        ...
        // then
        Order getOrder = orderRepository.findOne(orderId);
        assertEquals("주문 취소시 상태는 CANCEL이다",
                OrderStatus.CANCEL, getOrder.getStatus());
        assertEquals("주문 취소시 재고는 원상복귀되어야 한다.",
    ...
    private Member createMember() {
        ...
        member.setAddress(new Address("seoul", "강가", "23415"));
        em.persist(member);
        return member;
    }
}